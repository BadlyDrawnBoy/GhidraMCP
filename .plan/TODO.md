...
**What changed:** Added a fully paginated `/api/search_strings.json` endpoint, MCP tool, schemas, and client plumbing that search all strings before slicing while emitting pagination metadata.
